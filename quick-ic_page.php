...
<head>
    ...
    <link rel="stylesheet" href="./css/quick-ic_page.css">
                            ...
                            <div id="tab01" class="tab">
                                <div class="category_tab2_wrap">
                                    ...
                                    <div class="category_tabcontent2">
                                        ...
                                        <div id="tab01-02" class="tab2"></div>
                                        <div id="tab01-03" class="tab2"></div>
                                        <div id="tab01-04" class="tab2"></div>
                                        <div id="tab01-05" class="tab2"></div>
                                        <div id="tab01-06" class="tab2"></div>
                                        <div id="tab01-07" class="tab2"></div>
                                        <div id="tab01-08" class="tab2"></div>
                                    </div>
                                </div>
                            </div>
