...
<body>
    ...
    <div class="itemThum">
        ...
        <div class="itemThumText">
            ...
            <div class="itemName">브러쉬 립조직 하이넥 티셔츠</div>
            <div class="itemOpt">
                <span class="color">블랙</span>ㅣ<span class="size">S</span>
            </div>
        </div>
    </div>
    <div class="cancelReasonWrap">
        <span>취소사유</span> 
        <div class="selectBox_type">
            ...
            <ul class="optionItem_wrap" id="crops1">
                ...
                <li class="optionItem">상품 불만족</li>
                <li class="optionItem">배송지연</li>
                <li class="optionItem">상품정보 상이</li>
                <li class="optionItem">삼품품절</li>
                <li class="optionItem">색상 및 사이즈 변경</li>
                <li class="optionItem">다른상품 잘못 주문</li>
            </ul>
        </div> 
    ...
    <div class="bottom">
         <div class="bottomContainer">
            <button>취소접수</button><!-- 셀렉트박스 체크되고 textBox에 텍스트 기입시 class='on' 추가 -->
         </div>
    </div>
</body>
<script>
